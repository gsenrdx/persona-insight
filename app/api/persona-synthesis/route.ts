      ...
      try {
        if (isNewPersona) {
          ...
          const insertData = {
            ...
            thumbnail: (outputs.thumbnail && outputs.thumbnail !== null) ? outputs.thumbnail : null,
          ...
          if (outputs.thumbnail && outputs.thumbnail !== null) updateData.thumbnail = outputs.thumbnail;
