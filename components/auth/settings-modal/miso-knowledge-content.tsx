...
interface MisoKnowledgeStatusContentProps {
  companyId: string
  projectId?: string
}

export function MisoKnowledgeStatusContent({
  companyId,
  projectId
}: MisoKnowledgeStatusContentProps) {
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b bg-white flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">MISO Knowledge 연동 상태</h3>
